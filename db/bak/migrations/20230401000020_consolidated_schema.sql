...
CREATE TABLE flexitype.attribute_definition_version (
                                                        ...
                                                        FOREIGN KEY (type_name, type_version) REFERENCES flexitype.type_definition_version(name, version)
);
...
CREATE TABLE flexitype.validation_rule_version (
                                                   ...
                                                   created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                                   FOREIGN KEY (type_name, type_version, attribute_name) REFERENCES flexitype.attribute_definition_version(type_name, type_version, name)
);
...
-- Create type_definition table with name as the primary key
...
-- Create attribute_definition table with composite primary key
...
COMMENT ON TABLE flexitype.type_definition_version IS 'Stores type definitions with name as the primary key';
COMMENT ON TABLE flexitype.attribute_definition_version IS 'Stores attribute definitions with composite primary key (type_name, type_version, name)';
...
COMMENT ON COLUMN flexitype.type_definition_version.name IS 'Unique name that serves as the primary identifier for this type';
COMMENT ON COLUMN flexitype.attribute_definition_version.name IS 'Name of the attribute, part of the composite primary key';
