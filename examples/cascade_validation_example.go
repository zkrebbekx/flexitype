...
func main() {
	...
	productType2, err := client.SaveType(ctx, "product-002", "Product2", "Product record 2")
	if err != nil {
	...
	productType3, err := client.SaveType(ctx, "product-003", "Product3", "Product record 3")
	if err != nil {
	...
	// Create a fresh product type for this test
	productType4, err := client.SaveType(ctx, "product-004", "Product4", "Product record 4")
	if err != nil {
