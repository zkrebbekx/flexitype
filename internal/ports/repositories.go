...
type QueryOptions struct {
	...
	Names []string // Primary keys or foreign keys
...
type TypeRepository interface {
	...
	ArchiveMany(ctx context.Context, names []string) error

	// GetByNameAndVersion retrieves a specific version of a type definition
	GetByNameAndVersion(ctx context.Context, name string, version int) (*core.TypeDefinition, error)
}
